...
powershell -command "(New-Object System.Net.WebClient).DownloadFile('https://github.com/serifpersia/esp32partitiontool/releases/download/v1.0/ESP32PartitionTool.zip', 'ESP32PartitionTool.zip')"
